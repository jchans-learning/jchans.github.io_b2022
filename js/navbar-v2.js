      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav">
          <li class="nav-item d-flex active">
            <a class="nav-link fa-lg mx-2" href="https://github.com/jchans" target="_blank"><i
                class="fab fa-github-square"></i></a>
            <a class="nav-link fa-lg mx-2" href="https://www.linkedin.com/in/hans-chiang-8b890913b/" target="_blank">
              <i class="fab fa-linkedin"></i>
            </a>
            <a class="nav-link fa-lg mx-2" href="https://www.facebook.com/hanschiang86/" target="_blank">
